...
module.exports = (homebridge) => {
  ...
  homebridge.registerAccessory('dersu-switch', 'MacSwitch', SwitchAccessory)
}
...
class SwitchAccessory {
  ...
  getServices () {
    ...
    const informationService = new Service.AccessoryInformation()
        .setCharacteristic(Characteristic.Manufacturer, 'dersu')
        .setCharacteristic(Characteristic.Model, 'MacSwitch')
